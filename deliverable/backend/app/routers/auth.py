...
from ..models import User, Staff  # FIX: Import kedua model tabel ini
...
def login(
    ...
    # 2. Jalur Kedua: Jika tidak ada di tabel User, cari di tabel Staff (untuk Josh, Rara, dll.)
    ...
    if staff and staff.hashed_password:
        ...
        if pwd_context.verify(form.password, staff.hashed_password):
            # Buat token token akses dengan sub username dan role milik staff
