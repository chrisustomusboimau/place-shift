...
def matrix(
    ...
    for a in assignments:
        # FIX UTAMA: Kondisional penentuan teks label visual jika staf sedang izin/absen
...
def create_assignment(
    ...
    # FIX UTAMA: Lewati validasi pengecekan tabel ruangan jika tipe tugas berupa izin/absen (location_id: null)
...
def update_assignment(
    ...
    # FIX UTAMA: Validasi lokasi fisik ruangan hanya jika target pembaruan bukan status izin
    if not new_leave:
